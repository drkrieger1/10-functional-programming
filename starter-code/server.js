...
const app = express();
const conString = 'postgres://postgres:lih9gsf@localhost:5432/kilovolt';
// const conString = 'postgres://postgres:lih9gsf@localhost:3000/kilovolt'; // DONE: Don't forget to set your own conString
const client = new pg.Client(conString);
client.connect();
client.on('error', function(err) {
  console.error(err, 'awww hell bill');
});
